package com.bc.zhongyuan.charge.web.aop;


import com.bc.zhongyuan.charge.util.ClassUtil;

import com.bc.zhongyuan.charge.util.annotation.Valid;
import com.bc.zhongyuan.charge.util.annotation.Valids;
import com.bc.zhongyuan.charge.util.exception.IllegalParamException;
import com.bc.zhongyuan.charge.util.exception.ParamAbsentException;
...
public class ArgumentValid {
	@Around(value = "@annotation(com.bc.zhongyuan.charge.util.annotation.Valids)")
